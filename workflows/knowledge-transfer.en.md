...
**Cause**: "I know how to do it but can't explain it"
**Solution**: Structured interview method
...
**Cause**: Operational activity priority
**Solution**: Opportunistic incremental documentation
...
**Cause**: Training perceived as constraint, no felt need
**Solution**: Intrinsic motivation + recognition
...
**Cause**: Standards change, techniques evolve
**Solution**: Versioning + annual review
